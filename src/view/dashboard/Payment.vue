        ...
        <div class="container p-5">
            <div class="row">
                <button class="btn btn-secondary col-12 bbs-1" style="background-color: #F8F9FD; border-width: 0px;">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <h6 class="h6-2">Total Amount</h6>
                            </div>
                            <div class="col-5"></div>
                            <div class="col-3">
                                <h6 class="h6-4">$ 64.00</h6>
                            </div>
                        </div>
                    </div>
                </button>
            ...
            <div class="row">
                <div class="col-4 mt-3 mb-3">
                    <h6 class="h6-5">Payment method</h6>
                </div>
                <div class="col-8"></div>
            </div>
            <div class="row">
            ...
            <div class="row" style="padding: 10px;">
                <div class="col-4" v-for="number in [1, 2, 3, 4, 5, 6, 7, 8, 9, 0]">
                    <button type="button" class="btn btn-primary bbp-1 mt-3" style="width: 110px;
                                                    ...
                                                    border-width: 0px;" @click="addNumberToInput(number)">
                        <h6 class="h6-6">{{ number }}</h6>
                    </button>
                </div>
            </div>
            <!-- Tugma bloklari -->
